...
class RequestDriverPriceField extends StatelessWidget {
  const RequestDriverPriceField({super.key});

  static TextEditingController requestDriverPriceController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text('مبلغ الطلبية', style: Theme.of(context).textTheme.bodyMedium),
          const SizedBox(height: 8),
          BlocBuilder<MerchantProductsCubit, MerchantProductsStates>(
            builder: (context, state) {
              return CustomTextFormField(
                controller: requestDriverPriceController,
                hint: '0',
