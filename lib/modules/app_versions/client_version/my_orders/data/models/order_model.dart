  ...
  factory OrderModel.fromJson(Map<String, dynamic> json) =>
      OrderModel(
        ...
        json['merchant'] is Map
            ? MerchantPhoneModel
            .fromJson(json['merchant'])
            .phone
            : "",
        billNo: json['billNo'],
        items: List<ProductItemModel>.from(
          json['items'].map((e) => ProductItemModel.fromJson(e)),
        ),
...
class MerchantLocationModel extends MerchantLocation {
  ...
  factory MerchantLocationModel.fromJson(Map<String, dynamic> json) =>
      MerchantLocationModel(
        coordinates: List<num>.from(json['coordinates'].map((e) => e)),
      );
}
  ...
  factory ClientModel.fromJson(Map<String, dynamic> json) =>
      ClientModel(
        ...
        json['region'] != null
            ...
            : null,
        city:
        json['city'] != null ? RegionAndCityModel.fromJson(json['city']) : null,
      );
}
